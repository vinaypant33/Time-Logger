...
class TaskList():
    ...
    def adding_tasklist(self):
        ...
        self.task_frame = btk.Frame(self.controls_frame , width=self.width+10 , height=35 ,bootstyle = "success")
    ...
    def __init__(self ,master ,  width  = 500 , height  = 600) -> None:
        ...
        self.controls_frame = ttk.Frame(self.main_canvas , width=self.width , height=200 , bootstyle = "warning" )
        ...
        self.add_button.pack(side=tk.TOP , pady=10 , padx=10 , anchor="ne")
